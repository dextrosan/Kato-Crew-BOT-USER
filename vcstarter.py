...
if vcbot is not None:
    ...
    async def join_call(data):
        try:
            ...
            return await bot.send_message(
                data["chat"]["id"], f"Por favor añadir `{name}`` en este grupo."
            )
        ...
        try:
            ...
            return await bot.send_message(
                data["chat"]["id"], f"`Por favor añadir{stree} en este grupo.`"
            )
        except Exception as ex:
            return await bot.send_message(data["chat"]["id"], "`" + str(ex) + "`")
        try:
        ...
        if not call:
            return await bot.send_message(
                data["chat"]["id"],
                "`No puedo acceder al chat de voz.`",
            )
        ...
        try:
            ...
            await bot.send_message(
                Var.LOG_CHANNEL,
                f"`Se unió al chat de voz en {(await bot.get_entity(data['chat']['id'])).title}`",
            )
        except Exception as ex:
            return await bot.send_message(data["chat"]["id"], "`" + str(ex) + "`")
    ...
    async def leave_call(data):
        ...
        try:
            ...
            await bot.send_message(
                Var.LOG_CHANNEL,
                f"Chat de voz izquierdo en `{data['chat']['title']}`",
            )
        except Exception as ex:
            return await bot.send_message(
                data["chat"]["id"],
        ...
        async for msg in ws:
            if msg.type == WSMsgType.TEXT:
                ...
                if data["_"] == "leave":
                    await bot.send_message(
                        Var.LOG_CHANNEL,
                        f"Recibido ** Solicitud de licencia** In `{data['data']['chat']['title']}`",
                    )
                    await bot.send_message(
                        data["data"]["chat"]["id"],
                        f"Recibido ** Solicitud de licencia ** En `{data['data']['chat']['title']}`",
                    )
