...
• `{i}sticker <query>`
    Buscar stickers según tu deseo.

• `{i}getaudio <reply to an audio>`
    Descargar audio para poner en su deseado Video/Gif.

• `{i}addaudio <reply to Video/gif>`
    Pondrá el audio anterior a la respuesta. video/gif.

• `{i}dob <date of birth>`
    Meter en dd/mm/yy Solo formato(eg .dob 01/01/1999).

• `{i}wall <query>`
    Buscar fondo de pantalla HD según su deseo..
"""
