...
# ================================================#
notmine = f"Este bot es para {OWNER_NAME}"
...
async def e(o):
    if len(o.text) == 0:
        ...
        header = udB.get("ALIVE_TEXT") if udB.get("ALIVE_TEXT") else "Ey,  Estoy vivo!!."
        ...
        res = [
            await b.article(
                title="AL CAPONE BOT",
                url="https://t.me/Dextrov",
                description="AL CAPONE | Telethon ",
                text=ALIVEMSG,
                thumb=InputWebDocument(ULTROID_PIC, 0, "https://external-content.duckduckgo.com/iu/?u=http%3A%2F%2F33.media.tumblr.com%2F9cebcec899889b81f2adea7b5486fdbb%2Ftumblr_ne8fbcYjVR1ru5h8co1_500.gif&f=1&nofb=1", []),
                buttons=[
                    [Button.url(text="Soporte", url="t.me/Dextrov")],
                    [
                        Button.url(
                            text="Repo",
                            url="https://t.me/Dextrov",
        ...
        await o.answer(res, switch_pm=f"👥 AL CAPONE PORTAL", switch_pm_param="start")
...
if asst.me is not None:
    ...
    async def on_plug_in_callback_query_handler(event):
        ...
        try:
            ...
            pass
        if help_string == "":
            reply_pop_up_alert = f"{plugin_name} no tiene ayuda detallada..."
        else:
        ...
        try:
            ...
            halps = f"Do .help {plugin_name} para obtener la lista de comandos."
