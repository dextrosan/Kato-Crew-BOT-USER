...
• `{i}afk <optional reason>`
    AFK significa lejos del teclado,
     Después de que usted active esto, si alguien etiqueta o envía un mensaje, entonces le responde automáticamente,
     (Nota: Al responder a cualquier medio, U también puede configurar el afk de medios).
